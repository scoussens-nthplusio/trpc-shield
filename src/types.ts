...
export declare class IRule {
  ...
  resolve(ctx: { [name: string]: any }, type: string, path: string, rawInput: string, options: IOptions): Promise<IRuleResult>
}
...
export declare class ILogicRule {
  ...
  getRules(): ShieldRule[]
  evaluate(ctx: { [name: string]: any }, type: string, path: string, rawInput: string, options: IOptions): Promise<IRuleResult[]>
  resolve(ctx: { [name: string]: any }, type: string, path: string, rawInput: string, options: IOptions): Promise<IRuleResult>
}

export type IRuleResult = boolean | string | Error
export type IRuleFunction = (ctx: { [name: string]: any }, type: string, path: string, rawInput: string, options: IOptions) => IRuleResult | Promise<IRuleResult>
