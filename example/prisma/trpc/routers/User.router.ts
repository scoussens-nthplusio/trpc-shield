...
import { shieldedProcedure, t } from './helpers/createRouter'
...
export const usersRouter = t.router({
  ...
  findFirstUserOrThrow: shieldedProcedure.input(UserFindFirstSchema).query(async ({ ctx, input }) => {
  ...
  findUniqueUserOrThrow: shieldedProcedure.input(UserFindUniqueSchema).query(async ({ ctx, input }) => {
